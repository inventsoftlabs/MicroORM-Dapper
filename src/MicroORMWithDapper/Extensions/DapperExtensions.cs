namespace MicroORMWithDapper
{
    ...
    public static class DapperExtensions
    {
        ...
        /// <summary>
        /// To validate the concurrent violation.
        /// </summary>
        /// <typeparam name="T">Represents entity Type</typeparam>
        /// <param name="item">Represents entity object</param>
        /// <returns>Returns true if concurrent violation take place other wise returns false.</returns>
        public static bool ValidateConcurrentViolation<T>(this T item) where T : EntityBase
        {
